# Generated by Django 6.0.1 on 2026-01-21 08:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employment_type', models.CharField(choices=[('internship', 'Internship'), ('full_time', 'Full Time'), ('contract', 'Contract')], max_length=20)),
                ('salary_min', models.IntegerField(blank=True, null=True)),
                ('salary_max', models.IntegerField(blank=True, null=True)),
                ('coding_required', models.BooleanField(default=False)),
                ('cutoff_score', models.IntegerField(blank=True, null=True)),
